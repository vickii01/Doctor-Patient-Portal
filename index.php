...
.aa:hover{
  ...
  <body>
	...
	<div class="col-md-6">
	<div style="text-align:justify; opacity:" class="well">
	<font size="8px"><b>Doctor Patient portals</b></font> are secure, convenient online tools that help you to manage and keep track of you and your family’s health 24/7.
...
<img style="margin-left:10%;float:left; margin-top:-5%;opacity:0.8;" width="270px"  src="img/logom.png"/>
	...
	<img style="margin-top:0.0%;"  class="dppbanner" src="img/01.jpg"/>
...
?>
	...
	<div style="width:102.5%; margin-left:-1.2%;margin-top:-5%;" class="container footer"><center>&copy; 2021 | All Rights Reserved |	<a style="color:white;" href="sitemap.php">Sitemap</a></center></div>
	</div>
	</div>
